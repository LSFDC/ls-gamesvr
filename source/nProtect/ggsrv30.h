...
class EXPORT_CLASS CCSAuth3_SmallMemory
{	
public:
	CCSAuth3_SmallMemory();
	~CCSAuth3_SmallMemory();

	UINT32 Init( BOOL bIsFirstServer );
	UINT32 Close();

	UINT32 Get( IN OUT PBYTE pbPacket, IN OUT UINT32 *puSize );
	UINT32 Check( IN PBYTE pbPacket, IN UINT32 uSize );
