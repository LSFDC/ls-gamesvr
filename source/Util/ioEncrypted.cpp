	...
	bool Encode15( const char* szPlain, const char* szUserKey, char *szCipher, NationType eNationType /*= NT_KOREA */ )
{
	...
	{
		LOG.PrintTimeAndLog( LOG_DEBUG_LEVEL,"Encode15 - Error -1");
		return false;
	}
	...
	{
		LOG.PrintTimeAndLog( LOG_DEBUG_LEVEL,"Encode15 - Error -2");
		return false;
	}
	...
	{
		LOG.PrintTimeAndLog( LOG_DEBUG_LEVEL,"Encode15 - Error -3");
		return false;
	}
	
	if(SEED_EncInit(&AlgInfo) != CTR_SUCCESS)
	{
		LOG.PrintTimeAndLog( LOG_DEBUG_LEVEL,"Encode15 - Error -4");
		return false;
	}
	...
	{
		LOG.PrintTimeAndLog( LOG_DEBUG_LEVEL,"Encode15 - Error -5");
		return false;
	}
	...
	{
		LOG.PrintTimeAndLog( LOG_DEBUG_LEVEL,"Encode15 - Error -6");
		return false;
	}
	...
	strcpy_s(szCipher, sizeof(szCipher), szTemp);
	return true;
}
...
bool Decode15( char *szCipher, char *szUserKey, char *szPlain, NationType eNationType /*= NT_KOREA */ )
{
	...
	{
		LOG.PrintTimeAndLog( LOG_DEBUG_LEVEL,"Decode15 - Error -1");
		return false;
	}
	...
	if(LenUserKey >= SEED_USER_KEY_LEN)
	{
		LOG.PrintTimeAndLog( LOG_DEBUG_LEVEL,"Decode15 - Error -2");
		return false;
	}
	...
	if(SEED_KeySchedule(UserKey, SEED_USER_KEY_LEN, &AlgInfo) != CTR_SUCCESS)
	{
		LOG.PrintTimeAndLog( LOG_DEBUG_LEVEL,"Decode15 - Error -3");
		return false;
	}
	
	if(SEED_DecInit(&AlgInfo) != CTR_SUCCESS)
	{
		LOG.PrintTimeAndLog( LOG_DEBUG_LEVEL,"Decode15 - Error -4");
		return false;
	}
	...
	{
		LOG.PrintTimeAndLog( LOG_DEBUG_LEVEL,"Decode15 - Error -5");
		return false;
	}
